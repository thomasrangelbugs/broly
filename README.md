...
- **Toque no retrato** (ou escolha na lista) para trocar de personagem: Broly, Super Broly, Goku, Vegeta, Gohan, Goku Black, Cell, Freeza, Majin Buu e Thor.
- **Segure no personagem** para carregar a transformação daquela trilha.
- **Solte** para parar na forma atual.
- Broly clássico passa por **Restrained** antes do Super Saiyan.
- Formas extras na trilha: Goku **Kaio-ken x20** e Vegeta **Blue Full Power**.
- Thor usa a forma **Endgame** e a forma suprema **Odin**.
- No fim da trilha, toque na **forma suprema** (Legend, UI, UE, Rose, Beast, Cell Ultra, Black Freeza, Kid Buu, Odin — conforme o personagem).
